...
Note the message informs where your packages come from and go to by default:
...
The default user library is controlled via the environmnt variable `R_LIBS_USER`.
