...
What if you want to shift focus from project A to project B, or have both open?
...
If running multiple scripts from a "controller", run each in its own R session.:
